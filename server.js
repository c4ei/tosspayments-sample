...
var secretKey = process.env.TOSS_SEC_KEY; //"test_gsk_docs_OaPz8L5KdmQXkzRz3y47BMw6";
...
app.listen(process.env.PORT, () => console.log(`http://localhost:${process.env.PORT} 으로 샘플 앱이 실행되었습니다.`));
